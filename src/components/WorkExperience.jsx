...
const WorkExperience = () => {
  ...
  const sortedProjects = [...filteredProjects].sort(
    (a, b) => parseDateToTime(b.startDate) - parseDateToTime(a.startDate)
  );
      ...
      <div className="glass-effect p-6 sm:p-8">
        ...
        <div className="relative border-l-2 border-gray-700">
          {sortedProjects.map((project, index) => (
            <div
              key={project.name}
              className="mb-6 pl-10 sm:pl-12 relative group"
            >
                      ...
                      <>
                        {visibleTags.map((tag, i) => (
                          <li
                            ...
                            className="px-3 py-1 text-xs font-semibold bg-gray-700 text-cyan-400 rounded-full"
                          >
                            {tag}
                          </li>
                        ))}
